...
object AriaVocabulary {
  ...
  /** Every role in ARIA 1.2, abstract roles excluded: those are not allowed in markup. */
  ...
  val tokenValues: Map[String, Set[String]] = Map(
    ...
    "aria-current"         -> Set("page", "step", "location", "date", "time", "true", "false"),
    "aria-disabled"        -> Set("true", "false"),
    "aria-expanded"        -> Set("true", "false", "undefined"),
    "aria-haspopup"        -> Set("false", "true", "menu", "listbox", "tree", "grid", "dialog"),
  ...
  val autocompleteModifiers: Set[String] = Set("shipping", "billing", "home", "work", "mobile", "fax", "pager")
}
